...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent(){
        ...
        labelrollno = new JLabel("1228"+first4);
        ...
        lblx.setFont(new Font("serif",Font.PLAIN,20));
        add(lblx);
        ...
        lblxii.setFont(new Font("serif",Font.PLAIN,20));
        add(lblxii);
        ...
        String course [] = {"B.Tech","BBA","BCA","Bsc","B.Com","BA","Msc","MBA","MCA","M.Tech","M.Com","MA"};
        ...
        String branch [] = {"Computer Science","Electronics","Mechanical","Civil","IT","IC","EC"};
